...
@Component({
  selector: 'page-updateprovpassword',
  templateUrl: 'updateprovpassword.html',
})
export class UpdateprovpasswordPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad UpdateprovpasswordPage');
  }
  ...
  update()
  {
    ...
    this.apiUrl = 'http://secedu.info/mycity/updateserpass.php?password=' + this.password + '&email=' + this.email;
